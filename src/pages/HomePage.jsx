...
function HomePage() {
  ...
  const galleryCategories = [{
    ...
    images: [{
      ...
      src: '/images/Cabanas_Premium/baño.png',
        ...
        <section className="section-spacing bg-secondary text-primary-foreground">
          <div className="section-container text-center">
            ...
            duration: 0.5
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <ReservationButton size="lg" className="bg-background text-foreground hover:bg-background/90 text-lg px-8" text="Reservar ahora" />
